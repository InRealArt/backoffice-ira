...
export async function updateArtist(
    ...
    try {
        ...
        const allowedData = {
            ...
            imageUrl: toRelativePath(typeof data.imageUrl === 'string' ? data.imageUrl : undefined) ?? (typeof data.imageUrl === 'string' ? data.imageUrl : null),
            isGallery: data.isGallery,
            backgroundImage: toRelativePath(typeof data.backgroundImage === 'string' ? data.backgroundImage : undefined) ?? (typeof data.backgroundImage === 'string' ? data.backgroundImage : null),
            slug: data.slug,
            featuredArtwork: toRelativePath(typeof data.featuredArtwork === 'string' ? data.featuredArtwork : undefined) ?? (typeof data.featuredArtwork === 'string' ? data.featuredArtwork : null),
