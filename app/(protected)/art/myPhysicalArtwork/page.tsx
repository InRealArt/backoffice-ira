        ...
        <>
          <div className="section">
            <div className={styles.listContainer}>
              {itemsData.map((item) => {
                const views = (item.physicalItem?.realViewCount || 0) + (item.physicalItem?.fakeViewCount || 0)
                ...
                return (
                  <div key={item.id} className={styles.row}>
                    ...
                    <div className={styles.info}>
                      <div className={styles.title}>{item.name || 'Sans titre'}</div>
                      <div className={styles.meta}>Créé le {formatDateFR(item.createdAt)}</div>
                      {price !== undefined && (
                    ...
                    <div className={styles.stats}>
                      <div className={styles.statItem}>
                        <span className="flex items-center gap-2"><Eye size={16} /> Vues</span>
