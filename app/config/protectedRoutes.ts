...
const protectedRoutes: Record<string, AccessLevel> = {
    ...
    "/dataAdministration/artworkMediums": "admin",
    "/dataAdministration/artworkMediums/[id]/edit": "admin",
    "/dataAdministration/artworkMediums/create": "admin",
    "/dataAdministration/artworkStyles": "admin",
    "/dataAdministration/artworkStyles/[id]/edit": "admin",
    "/dataAdministration/artworkStyles/create": "admin",
