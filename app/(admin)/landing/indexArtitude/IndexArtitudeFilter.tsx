...
import { indexArtitudeSearchParams } from './searchParams'

export function IndexArtitudeFilter() {
  const [searchParams, setSearchParams] = useQueryStates(indexArtitudeSearchParams, {
    shallow: false
  })
