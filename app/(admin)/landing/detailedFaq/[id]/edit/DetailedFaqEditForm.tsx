...
interface DetailedFaqEditFormProps {
  faqHeader: DetailedFaqHeaderWithItems
}

export default function DetailedFaqEditForm({ faqHeader }: DetailedFaqEditFormProps) {
  ...
  const onSubmitItem = async (data: ItemFormValues) => {
    ...
    try {
      const result = await createDetailedFaqItem({
        headerId: faqHeader.id,
  ...
  const handleCancel = () => {
    router.push('/landing/detailedFaq')
  }
      ...
      <div className="page-header">
        <div className="header-top-section">
          <h1 className="page-title">
            Éditer la section de FAQ : {faqHeader.name}
          </h1>
        </div>
          ...
          <div className="card-content">
            ...
            {isEditingHeader ? (
              ...
              <div className="info-display mt-md">
                ...
                <div className="info-item">
                  ...
                  <span className="info-value">{faqHeader.faqItems.length}</span>
                </div>
              </div>
            )}
            ...
            <div className="section-header mt-lg d-flex justify-content-between align-items-center">
              ...
              <div className="section-badge" style={{ 
                ...
                {faqHeader.faqItems.length} question(s)
              </div>
            </div>
            ...
            {faqHeader.faqItems.length === 0 ? (
              ...
              <div className="faq-items-list mt-md">
                {faqHeader.faqItems.map((item, index) => (
                  <div 
                    key={item.id} 
