  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        setTimeout(() => {
          router.push(`/landing/detailedGlossary/${result.data.id}/edit`)
          router.refresh()
        }, 1000)
      } else {
    ...
    <div className="page-container">
      <div className="page-header">
        <div className="header-top-section">
          <h1 className="page-title">Créer une nouvelle section de Glossaire détaillée</h1>
        </div>
        <p className="page-subtitle">
          Créez une nouvelle section de Glossaire détaillée pour le site
        </p>
      </div>
        ...
        <div className="form-card">
          ...
          <div className="card-footer">
            <div className="d-flex justify-content-between">
              <button
                type="button"
                onClick={() => router.push('/landing/detailedGlossary')}
